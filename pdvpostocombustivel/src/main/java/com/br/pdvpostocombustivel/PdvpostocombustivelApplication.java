...
@OpenAPIDefinition(
        info = @Info(
                ...
                contact = @Contact(name = "guilherme de freitas miranda", email = "user@example.com"),
                license = @License(name = "v1")
        ),
        servers = {
                @Server(url = "http://localhost:5555", description = "Ambiente Local")
        }
)
